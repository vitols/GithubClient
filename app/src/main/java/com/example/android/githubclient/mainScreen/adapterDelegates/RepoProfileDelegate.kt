 ...
 */
class RepoProfileDelegate(val context: Activity, val callback: (View) -> Unit) :
        AdapterDelegateAbstract<Any, Any, RepoProfileDelegate.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup): ViewHolder {
        return ViewHolder(LayoutInflater.from(context).inflate(R.layout.item_repo_profile, parent, false))
    }
